    ...
    <div class="container">
        <header class="border-bottom lh-1 py-3">
            <div class="row flex-nowrap justify-content-between align-items-center">
                ...
                <div class="col-4 text-center">
                    <a class="blog-header-logo text-body-emphasis text-decoration-none" href="javascript:void()0;">Laravel VueJs Blog</a>
                </div>
        ...
        <div class="nav-scroller py-1 mb-3 border-bottom">
            <nav class="nav nav-underline justify-content-between">
                <a class="nav-item nav-link link-body-emphasis active" href="javascript:void()0;">World</a>
                <a class="nav-item nav-link link-body-emphasis" href="javascript:void()0;">U.S.</a>
                <a class="nav-item nav-link link-body-emphasis" href="javascript:void()0;">Technology</a>
                <a class="nav-item nav-link link-body-emphasis" href="javascript:void()0;">Design</a>
                <a class="nav-item nav-link link-body-emphasis" href="javascript:void()0;">Culture</a>
                <a class="nav-item nav-link link-body-emphasis" href="javascript:void()0;">Business</a>
                <a class="nav-item nav-link link-body-emphasis" href="javascript:void()0;">Politics</a>
                <a class="nav-item nav-link link-body-emphasis" href="javascript:void()0;">Opinion</a>
                <a class="nav-item nav-link link-body-emphasis" href="javascript:void()0;">Science</a>
                <a class="nav-item nav-link link-body-emphasis" href="javascript:void()0;">Health</a>
                <a class="nav-item nav-link link-body-emphasis" href="javascript:void()0;">Style</a>
                <a class="nav-item nav-link link-body-emphasis" href="javascript:void()0;">Travel</a>
            </nav>
        </div>
    </div>
    ...
    <main class="container">
        <div class="p-4 p-md-5 mb-4 rounded text-body-emphasis bg-body-secondary">
            <div class="col-lg-6 px-0">
                ...
                <p class="lead mb-0"><a href="javascript:void()0;" class="text-body-emphasis fw-bold">Continue reading...</a></p>
            </div>
        </div>
